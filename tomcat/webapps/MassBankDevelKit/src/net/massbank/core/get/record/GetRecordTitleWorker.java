...
public class GetRecordTitleWorker extends BaseWorker {

	/**
	 * constructor
	 */
	public GetRecordTitleWorker(String dbName, Map<String, String> params) {
		super(dbName, params);
	}
	...
	@Override public List call() throws Exception {
		...
		if ( params.size() > 0 ) {
			...
			sql += "R.ID in(" + joinId + ") and ";
		}
		sql += "R.COMPOUND_NO=C.COMPOUND_NO and R.INSTRUMENT_NO=I.INSTRUMENT_NO order by R.ID";
